...
```{r,fig.height = 14, fig.width = 14, fig.align = "center",message=FALSE}
##Boxplot
library(reshape2)
library(ggprism)
library(ggpubr)
...
```{r,fig.height = 8, fig.width = 17, fig.align = "center",message=FALSE}
tpm_gene_log2 <- readRDS("../../tmp/tpm_gene_log2.rds")
tpm_gene <- tpm_gene_log2 %>%
  select(-id) %>%
...
```{r,message=FALSE,fig.height = 12, fig.width = 6, fig.align = "center"}
